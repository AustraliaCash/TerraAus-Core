### Building taustraliacash-qt 1.14 on modern macs. ###
...
### Clone taustraliacash locally, or check it out, etc. ###

For this purpose, just indicating the 1.14-branding branch in my repo.

	$git clone -b 1.14-branding --single-branch https://github.com/michilumin/taustraliacash.git
...
### Go back to your tAustraliaCash repo ###
...
Run it.
	...
	$/usr/local/bin/taustraliacash-qt
