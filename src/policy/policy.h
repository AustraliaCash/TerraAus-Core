...
/** Recommended transaction fee by tAustraliaCash Core developers
  *
 ...
 *
 *  tAustraliaCash:    Increment mempool limits and accept RBF in steps of 0.0001 tAUS
...
/**
 * tAustraliaCash: Default dust limit that is evaluated when considering whether a
...
/**
 * tAustraliaCash: Default hard dust limit that is evaluated when considering whether
