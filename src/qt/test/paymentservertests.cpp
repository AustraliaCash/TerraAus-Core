...
// Copyright (c) 2020 The tAustraliaCash Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // tAustraliaCash: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for tAustraliaCash (as there is no actual maximum coins)
