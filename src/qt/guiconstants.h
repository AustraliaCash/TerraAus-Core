...
#define QAPP_ORG_NAME "tAustraliaCash"
#define QAPP_ORG_DOMAIN "taustraliacash.org"
#define QAPP_APP_NAME_DEFAULT "tAustraliaCash-Qt"
#define QAPP_APP_NAME_TESTNET "tAustraliaCash-Qt-testnet"
